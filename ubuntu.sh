...
curl https://cloud-images.ubuntu.com/xenial/current/xenial-server-cloudimg-amd64-disk1.img -o /tmp/ubuntu.qcow2
...
# Copy base system
guestfish --ro -a /tmp/ubuntu.qcow2 -m /dev/sda1 -- tar-out / - | \
